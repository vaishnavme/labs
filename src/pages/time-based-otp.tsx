    ...
    <>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-8">
          <p>
            Time-based One-Time Password (TOTP) is a temporary passcode
            generated by an algorithm that uses the current time as one of its
            factors. It is commonly used for two-factor authentication (2FA) to
            enhance security.
          </p>
          ...
          <div>
            ...
            <p>
              Scan the generated QR code with your authenticator app (e.g.,
              Google Authenticator, Microsoft Authenticator) to add the TOTP
              account.
            </p>
          ...
          <div>
            ...
            <p>
              This is the OTP generated on the server side, which should match
